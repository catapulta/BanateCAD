...
# milk
convert Earth_8k_Nightlights_v001.tif -sample 8000x4000 -type grayscale -black-threshold 1% -modulate 1000 -normalize -morphology Dilate 'Disk:2' earthColorMap-i.8k.png
...
convert \( earth_spec.tif -normalize -negate +level 0,30% -sample 8000x4000 \) \
        \( earthBumpMap.8k.png +level 0,70% \) \
        -background black -compose plus -layers flatten -normalize earthBumpAddInvertedColorMap.8k.png

# exterior diameter, interior diameter, image width, image height, output filename, inverse multiplier
...
convert \( wlow_and_bright.png -modulate 90 -negate \) earthColorMap-i.8k.png -compose multiply -flatten earthColorMap.8k.png
